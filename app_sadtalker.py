...
def sadtalker_demo(
    ...
    with gr.Blocks(analytics_enabled=False) as sadtalker_interface:
        ...
        driven_audio = gr.Audio(
            label="Input audio", type="filepath", elem_id="driven_audio"
        )  # Define the driven_audio variable here
        ...
        )  # Define the preprocess_type variable here

        is_still_mode = gr.Checkbox(
            label="Still Mode (fewer head motion, works with preprocess `full`)",
            elem_id="is_still_mode",
        )  # Define the is_still_mode variable here

        enhancer = gr.Checkbox(
            label="GFPGAN as Face enhancer", elem_id="enhancer"
        )  # Define the enhancer variable here
        ...
        batch_size = gr.Slider(
            ...
            value=2,
            elem_id="batch_size",
        )  # Define the batch_size variable here
        ...
        size_of_image = gr.Radio(
            ...
            elem_id="size_of_image",
        )  # Define the size_of_image variable here
        ...
        pose_style = gr.Slider(
            ...
            value=0,
            elem_id="pose_style",
        )  # Define the pose_style variable here

        gen_video = gr.Video(
            label="Generated video", format="mp4", elem_id="gen_video"
        )  # Define the gen_video variable here
